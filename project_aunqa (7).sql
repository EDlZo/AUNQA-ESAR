...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2025 at 10:31 AM
...
--
-- Table structure for table `committee_evaluations_วิศวกรรมคอมพิวเตอร์`
--

CREATE TABLE `committee_evaluations_วิศวกรรมคอมพิวเตอร์` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `committee_evaluations_วิศวกรรมคอมพิวเตอร์`
--

INSERT INTO `committee_evaluations_วิศวกรรมคอมพิวเตอร์` (`id`, `indicator_id`, `major_name`, `session_id`, `committee_score`, `strengths`, `improvements`, `created_at`, `updated_at`) VALUES
(1, 143, 'วิศวกรรมคอมพิวเตอร์', '1759486170', 5.00, 'ฟหasdasหฟหก', 'ฟหกฟหกฟหก', '2025-10-22 08:21:59', '2025-10-22 08:27:32');
...
(29, 1759486170, 143, NULL, NULL, NULL, '<p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\">หลักสูตร ปร.ด. วิศวกรรมพลังงาน เริ่มเปิดดำเนินการจัดการเรียนการสอน ในปี พ.ศ. 2559 และมีการปรับปรุงหลักสูตร ตามรอบระยะเวลา 5 ปี และมีการปรับปรุงย่อย โดยกรรมการผู้รับผิดชอบหลักสูตร และการปรับปรุงระดับรายวิชาโดยอาจารย์ผู้สอนระหว่างการใช้หลักสูตรอย่างต่อเนื่องเพื่อให้ทันต่อการเปลี่ยนแปลงที่เกิดขึ้น และเป็นไปตามเกณฑ์มาตรฐานสถาบันอุดมศึกษา พ.ศ. 2558 และกรอบมาตรฐานคุณวุฒิระดับอุดมศึกษาแห่งชาติ พ.ศ. 2552 &nbsp;โดยหลักสูตรที่ดำเนินการในปัจจุบันคือ หลักสูตร ปร.ด. วิศวกรรมพลังงาน หลักสูตรใหม่ พ.ศ. 2559 (สำหรับนิสิตเข้าศึกษาในปี พ.ศ. 2559-2563) และหลักสูตรปรับปรุง พ.ศ. 2564 (สำหรับนิสิตเข้าศึกษาในปี พ.ศ. 2564-2568)</p><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\">ซึ่งในการปรับปรุงหลักสูตร คณะกรรมการผู้รับผิดชอบหลักสูตรได้ดำเนินการตามแนวทางการจัดการศึกษาที่เน้นผลลัพธ์ (Outcome based education, OBE) มีการสำรวจและวิเคราะห์ความต้องการของผู้มีส่วนได้ส่วนเสีย ได้แก่กลุ่มนิสิตในอนาคต นิสิตปัจจุบัน และผู้ใช้บัณฑิต และวิเคราะห์ให้เป็นไปในทิศทางเดียวกับวิสัยทัศน์ และพันธกิจของมหาวิทยาลัยทักษิณ และคณะวิศวกรรมศาสตร์ ร่วมกับข้อมูลนโยบายและยุทธศาสตร์ชาติ และเป้าหมายการพัฒนาที่ยั่งยืนขององค์การสหประชาชาติ SDGs เพื่อกำหนดผลการเรียนรู้ที่คาดหวัง (PLOs) สมรรถนะที่จำเป็นของบัณฑิต ปรัชญาของหลักสูตร วัตถุประสงค์ของหลักสูตรเพื่อให้ได้คุณลักษณะของบัณฑิตที่พึงประสงค์ โดยในการปรับปรุงหลักสูตรมีผู้ทรงคุณวุฒิจากภายนอกเข้ามามีส่วนร่วมในการวิพากษ์ 3 ท่าน ผลลัพธ์การเรียนรู้ของหลักสูตร (Program Learning Outcomes : PLOs) และความเชื่อมโยงกับวิสัยทัศน์ ของมหาวิทยาลัยทักษิณ และคณะวิศวกรรมศาสตร์แสดงในเอกสารแนบที่ 1.1.1</p><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\">&nbsp;</p><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\"><strong>ตารางที่ 1 ผลลัพธ์การเรียนรู้ของหลักสูตร (หลักสูตรใหม่ พ.ศ. 2559)</strong></p><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\">สามารถสื่อสาร และนำเสนอทั้งในรูปแบบการพูดและการเขียนโดยใช้เทคโนโลยีสารสนเทศที่เหมาะสม</p><table border=\"1\" cellpadding=\"0\" cellspacing=\"0\" class=\"tablesorter tablesorter-default\" style=\"color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px; width: 937.188px;\"><thead><tr class=\"tablesorter-headerRow\"><th data-column=\"0\" class=\"tablesorter-header\" tabindex=\"0\" unselectable=\"on\" style=\"background: rgb(238, 238, 238); padding: 5px; border-bottom-width: 2px; border-bottom-color: rgb(204, 204, 204); height: 4px; width: 96.8608px; user-select: none;\"><div class=\"tablesorter-header-inner\"></div></th><th data-column=\"1\" class=\"tablesorter-header\" tabindex=\"0\" unselectable=\"on\" style=\"background: rgb(238, 238, 238); padding: 5px; border-bottom-width: 2px; border-bottom-color: rgb(204, 204, 204); height: 4px; width: 684.29px; user-select: none;\"><div class=\"tablesorter-header-inner\"></div></th><th data-column=\"2\" class=\"tablesorter-header\" tabindex=\"0\" unselectable=\"on\" style=\"background: rgb(238, 238, 238); padding: 5px; border-bottom-width: 2px; border-bottom-color: rgb(204, 204, 204); height: 4px; width: 118.764px; user-select: none;\"><div class=\"tablesorter-header-inner\"></div></th></tr></thead><tbody><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 98.8778px;\"><p style=\"line-height: 21.6px;\">ELO 1</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 686.307px;\"><p style=\"line-height: 21.6px;\">มีความรับผิดชอบต่อตนเอง สังคมและมีจรรยาบรรณในวิชาชีพ</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 120.781px;\"><p style=\"line-height: 21.6px;\">AF, P</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 98.8778px;\"><p style=\"line-height: 21.6px;\">ELO 2</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 686.307px;\"><p style=\"line-height: 21.6px;\">มีความรู้ความเข้าใจอย่างลุ่มลึกเกี่ยวกับหลักการทฤษฎีและเทคนิคการวิจัยในด้านวิศวกรรมพลังงาน</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 120.781px;\"><p style=\"line-height: 21.6px;\">C: (U)</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 98.8778px;\"><p style=\"line-height: 21.6px;\">ELO 3.1</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 686.307px;\"><p style=\"line-height: 21.6px;\">สามารถดำเนินการวิจัยได้อย่างถูกต้องตามระเบียบวิธีวิจัย ตลอดจนวิเคราะห์ สังเคราะห์ อภิปรายผล และนำไปประยุกต์ใช้เพื่อพัฒนานวัตกรรมได้อย่างเหมาะสม</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 120.781px;\"><p style=\"line-height: 21.6px;\">C: (A)</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 98.8778px;\"><p style=\"line-height: 21.6px;\">ELO 3.2</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 686.307px;\"><p style=\"line-height: 21.6px;\">สามารถพัฒนาความรู้ใหม่ พร้อมทั้งบูรณาการแนวคิดต่าง ๆ เพื่อประยุกต์ใช้ในการวางแผนและแก้ปัญหาด้านวิศวกรรมพลังงาน</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 120.781px;\"><p style=\"line-height: 21.6px;\">C: (A)</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 98.8778px;\"><p style=\"line-height: 21.6px;\">ELO 4</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 686.307px;\"><p style=\"line-height: 21.6px;\">มีมนุษยสัมพันธ์ที่ดี สามารถปรับตัวและทำงานร่วมกับผู้อื่นทั้งในฐานะผู้นำและผู้ตามได้อย่างมีประสิทธิภาพ</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 120.781px;\"><p style=\"line-height: 21.6px;\">AF, P</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 98.8778px;\"><p style=\"line-height: 21.6px;\">ELO 5.1</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 686.307px;\"><p style=\"line-height: 21.6px;\">สามารถค้นคว้าความรู้ที่ถูกต้อง และทันสมัย เพื่อการเรียนรู้ได้ตลอดชีวิต</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 120.781px;\"><p style=\"line-height: 21.6px;\">AF, P</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 98.8778px;\"><p style=\"line-height: 21.6px;\">ELO 5.2</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 686.307px;\"><p style=\"line-height: 21.6px;\">AF, P</p></td></tr></tbody></table><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\"><strong>หมายเหตุ</strong>&nbsp;C= Cognitive (U = Remembering/understanding , A=Applying /Analyzing, E= Evaluation/Creating) AF= Affective, P = Psychomotor</p><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\">&nbsp;</p><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\"><strong>ตารางที่ 2 ผลลัพธ์การเรียนรู้ของหลักสูตร (หลักสูตรปรัปปรุง พ.ศ. 2564)</strong></p><table border=\"1\" cellpadding=\"0\" cellspacing=\"0\" class=\"tablesorter tablesorter-default\" style=\"color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px; width: 943.139px;\"><thead><tr class=\"tablesorter-headerRow\"><th data-column=\"0\" class=\"tablesorter-header\" tabindex=\"0\" unselectable=\"on\" style=\"background: rgb(238, 238, 238); padding: 5px; border-bottom-width: 2px; border-bottom-color: rgb(204, 204, 204); height: 4px; width: 124.29px; user-select: none;\"><div class=\"tablesorter-header-inner\"></div></th><th data-column=\"1\" class=\"tablesorter-header\" tabindex=\"0\" unselectable=\"on\" style=\"background: rgb(238, 238, 238); padding: 5px; border-bottom-width: 2px; border-bottom-color: rgb(204, 204, 204); height: 4px; width: 656.889px; user-select: none;\"><div class=\"tablesorter-header-inner\"></div></th><th data-column=\"2\" class=\"tablesorter-header\" tabindex=\"0\" unselectable=\"on\" style=\"background: rgb(238, 238, 238); padding: 5px; border-bottom-width: 2px; border-bottom-color: rgb(204, 204, 204); height: 4px; width: 124.688px; user-select: none;\"><div class=\"tablesorter-header-inner\"></div></th></tr></thead><tbody><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 126.307px;\"><p style=\"line-height: 21.6px;\"><strong>PLO 1</strong></p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 658.906px;\"><p style=\"line-height: 21.6px;\"><strong>สร้างองค์ความรู้เชิงลึกแบบบูรณาการด้านพลังงานทดแทนให้เหมาะกับบริบทสังคม</strong></p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 126.705px;\"><p style=\"line-height: 21.6px;\"><strong>C: (E)</strong></p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 126.307px;\"><p style=\"line-height: 21.6px;\">Sub PLO 1A</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 658.906px;\"><p style=\"line-height: 21.6px;\">ประยุกต์ใช้ความรู้แบบบูรณาการในการพัฒนากระบวนการผลิตพลังงานทดแทน</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 126.705px;\"><p style=\"line-height: 21.6px;\">C: (A)</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 126.307px;\"><p style=\"line-height: 21.6px;\">Sub PLO 1B</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 658.906px;\"><p style=\"line-height: 21.6px;\">แก้ปัญหาในการปฏิบัติงานด้านกระบวนการผลิตพลังงานทดแทนได้อย่างสร้างสรรค์และเหมาะสมตามบริบทของสังคม</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 126.705px;\"><p style=\"line-height: 21.6px;\">C: (E)</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 126.307px;\"><p style=\"line-height: 21.6px;\">Sub PLO 1C</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 658.906px;\"><p style=\"line-height: 21.6px;\">วิเคราะห์ สังเคราะห์ และอภิปรายข้อมูลเชิงลึกของกระบวนการผลิตพลังงานทดแทน</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 14px; width: 126.705px;\"><p style=\"line-height: 21.6px;\">C: (A)</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.307px;\"><p style=\"line-height: 21.6px;\"><strong>PLO 2</strong></p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 658.906px;\"><p style=\"line-height: 21.6px;\"><strong>ประเมินการบริหารจัดการพลังงานได้อย่างมีประสิทธิภาพและประสิทธิผล</strong></p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.705px;\"><p style=\"line-height: 21.6px;\"><strong>C: (E)</strong></p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.307px;\"><p style=\"line-height: 21.6px;\">Sub PLO 2A</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 658.906px;\"><p style=\"line-height: 21.6px;\">คัดเลือกและประยุกต์ใช้ความรู้เชิงลึกด้านการจัดการและเศรษฐศาสตร์พลังงาน</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.705px;\"><p style=\"line-height: 21.6px;\">C: (A)</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.307px;\"><p style=\"line-height: 21.6px;\">Sub PLO 2B</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 658.906px;\"><p style=\"line-height: 21.6px;\">วิเคราะห์ สังเคราะห์ และอภิปรายข้อมูลเพื่อการวางแผนเพิ่มประสิทธิภาพในการใช้พลังงาน</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.705px;\"><p style=\"line-height: 21.6px;\">C: (E)</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.307px;\"><p style=\"line-height: 21.6px;\">Sub PLO 2C</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 658.906px;\"><p style=\"line-height: 21.6px;\">บูรณาการองค์ความรู้และสรุปประเมินเพื่อพัฒนาการบริหารจัดการด้านพลังงาน</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.705px;\"><p style=\"line-height: 21.6px;\">C: (E)</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.307px;\"><p style=\"line-height: 21.6px;\"><strong>PLO 3</strong></p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 658.906px;\"><p style=\"line-height: 21.6px;\"><strong>สร้างสรรค์องค์ความรู้และเทคโนโลยีเพื่อสร้างนวัตกรรมสังคมทางด้านวิศวกรรมพลังงานตามบริบทของสังคม</strong></p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.705px;\"><p style=\"line-height: 21.6px;\"><strong>C: (E)</strong></p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.307px;\"><p style=\"line-height: 21.6px;\">Sub PLO 3A</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 658.906px;\"><p style=\"line-height: 21.6px;\">วิเคราะห์ สังเคราะห์ และอภิปรายข้อมูลเพื่อวางแผนสร้างนวัตกรรมตามบริบทของสังคม ด้วยเทคโนโลยีหมาะสม</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.705px;\"><p style=\"line-height: 21.6px;\">C: (E)</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.307px;\"><p style=\"line-height: 21.6px;\">Sub PLO 3B</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 658.906px;\"><p style=\"line-height: 21.6px;\">ประยุกต์ใช้ความรู้และเทคโนโลยีในการพัฒนานวัตกรรมสังคมตามบริบทของสังคม</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.705px;\"><p style=\"line-height: 21.6px;\">C: (A)</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.307px;\"><p style=\"line-height: 21.6px;\">Sub PLO 3C</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 658.906px;\"><p style=\"line-height: 21.6px;\">สร้างนวัตกรรมสังคมโดยใช้สารสนเทศที่ได้จากการวิเคราะห์ข้อมูล</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.705px;\"><p style=\"line-height: 21.6px;\">C: (E)</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.307px;\"><p style=\"line-height: 21.6px;\"><strong>PLO 4</strong></p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 658.906px;\"><p style=\"line-height: 21.6px;\"><strong>แสดงออกถึงคุณลักษณะของ&nbsp;</strong><strong>SMART Energy Engineer</strong></p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.705px;\"><p style=\"line-height: 21.6px;\"><strong>AF, P</strong></p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.307px;\"><p style=\"line-height: 21.6px;\">Sub PLO 4A&nbsp;</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 658.906px;\"><p style=\"line-height: 21.6px;\">แสดงบทบาทหน้าที่ของตนเอง เคารพสิทธิของผู้อื่น และมีจรรยาบรรณในวิชาชีพ</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.705px;\"><p style=\"line-height: 21.6px;\">AF, P</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.307px;\"><p style=\"line-height: 21.6px;\">Sub PLO 4B</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 658.906px;\"><p style=\"line-height: 21.6px;\">มีภาวะผู้นำในการสร้างทีม และบริหารจัดการการทำงานร่วมกับผู้อื่นได้อย่างมีประสิทธิภาพ</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.705px;\"><p style=\"line-height: 21.6px;\">AF, P</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.307px;\"><p style=\"line-height: 21.6px;\">Sub PLO 4C</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 658.906px;\"><p style=\"line-height: 21.6px;\">มีความคิดสร้างสรรค์ และมีวุฒิภาวะในการแก้ไขปัญหา</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.705px;\"><p style=\"line-height: 21.6px;\">AF, P</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.307px;\"><p style=\"line-height: 21.6px;\">Sub PLO 4D</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 658.906px;\"><p style=\"line-height: 21.6px;\">ค้นคว้าความรู้ที่ถูกต้อง ทันสมัย และสื่อสารในรูปแบบการนำเสนอ และการเขียนบทความวิชาการโดยใช้เทคโนโลยีสารสนเทศที่เหมาะสม</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; height: 19px; width: 126.705px;\"><p style=\"line-height: 21.6px;\">AF, P</p></td></tr></tbody></table><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\"><strong>หมายเหตุ</strong>&nbsp;C= Cognitive (U = Remembering/understanding , A=Applying /Analyzing, E= Evaluation/Creating) AF= Affective, P = Psychomotor</p><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\">&nbsp;</p><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\">ในการกำหนดผลลัพธ์การเรียนรู้ของหลักสูตร ใช้กรอบแนวคิดของ&nbsp;<strong>“Bloom\'s taxonomy”</strong>&nbsp;กำหนดความรู้ ทักษะ และเจตคติ เชื่อมโยงไปสู่การกำหนดรายวิชา และผลลัพธ์การเรียนรู้ระดับรายวิชา โดยหลักสูตรได้ทำการสื่อสารข้อมูลรายละเอียดของหลักสูตร ไปยังผู้มีส่วนได้ส่วนเสียกลุ่มต่างๆ ด้วยช่องทางที่หลากหลาย ดังตารางที่ 3</p><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\">&nbsp;</p><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\"><strong>ตารางที่&nbsp;</strong><strong>3&nbsp;</strong><strong>กลุ่มผู้มีส่วนได้ส่วนเสียและช่องทางการประชาสัมพันธ์รายละเอียดของหลักสูตร</strong></p><d style=\"color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px; width: 340px;\"><p style=\"line-height: 21.6px;\">- เวปไซต์คณะวิศวกรรมศาสตร์</p><p style=\"line-height: 21.6px;\">- สื่อออนไลน์ ได้แก่ เฟสบุ๊ก อินสตาแกรม ไลน์คณะวิศวกรรมศาสตร์ เพจเฟสบุ๊กคณะฯ</p></d><table border=\"1\" cellpadding=\"0\" cellspacing=\"0\" style=\"color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\"><tbody><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; width: 274px;\"><p style=\"line-height: 21.6px;\"><strong>กลุ่มผู้มีส่วนได้ส่วนเสีย</strong><strong>เกี่ยวข้องกับหลักสูตร</strong></p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; width: 340px;\"><p style=\"line-height: 21.6px;\"><strong>ช่องทางการประชาสัมพันธ์</strong></p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; width: 274px;\"><p style=\"line-height: 21.6px;\">นิสิตปัจจุบันของหลักสูตร</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; width: 340px;\"><p style=\"line-height: 21.6px;\">- เวปไซต์คณะวิศวกรรมศาสตร์</p><p style=\"line-height: 21.6px;\">- สื่อออนไลน์ ได้แก่ เฟสบุ๊ก อินสตาแกรม ไลน์คณะวิศวกรรมศาสตร์ เพจเฟสบุ๊กคณะฯ</p><p style=\"line-height: 21.6px;\">- ไลน์กลุ่มหลักสูตรฯ</p><p style=\"line-height: 21.6px;\">- กิจกรรมปฐมนิเทศ</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; width: 274px;\"><p style=\"line-height: 21.6px;\">ครู หรือ อาจารย์ ในวิทยาลัย/มหาวิทยาลัยต่างๆ</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; width: 340px;\"><p style=\"line-height: 21.6px;\">- เวปไซต์คณะวิศวกรรมศาสตร์</p><p style=\"line-height: 21.6px;\">- สื่อออนไลน์ ได้แก่ เฟสบุ๊ก อินสตาแกรม ไลน์คณะวิศวกรรมศาสตร์ เพจเฟสบุ๊กคณะฯ</p><p style=\"line-height: 21.6px;\">- ประชาสัมพันธ์ผ่านเครือข่ายอาจารย์ นิสิตปัจจุบัน และศิษย์เก่า</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; width: 274px;\"><p style=\"line-height: 21.6px;\">บุคคลทั่วไป</p></td></tr><tr><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; width: 274px;\"><p style=\"line-height: 21.6px;\">ผู้ใช้บัณฑิต ได้แก่ ภาคอุตสาหกรรม หน่วยงานของรัฐ และรัฐวิสาหกิจที่เกี่ยวข้องกับวิศวกรรมพลังงาน</p></td><td style=\"border-bottom-width: 1px; border-bottom-color: rgb(204, 204, 204); background: rgb(238, 238, 238); padding: 4px; width: 340px;\"><p style=\"line-height: 21.6px;\">- เวปไซต์คณะวิศวกรรมศาสตร์</p><p style=\"line-height: 21.6px;\">- สื่อออนไลน์ ได้แก่ เฟสบุ๊ก อินสตาแกรม ไลน์คณะวิศวกรรมศาสตร์ เพจเฟสบุ๊กคณะฯ</p><p style=\"line-height: 21.6px;\">- ประชาสัมพันธ์ผ่านเครือข่ายอาจารย์ นิสิตปัจจุบัน และศิษย์เก่า</p></td></tr></tbody></table><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\">&nbsp;</p><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\">จากการเก็บข้อมูลช่องทางรับทราบข่าวสารและรายละเอียดของหลักสูตรฯ ของนิสิตแรกเข้า และนิสิตปัจจุบัน ด้วยการสอบถาม พบว่า</p><ul style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\"><li>นิสิตแรกเข้าของหลักสูตร ช่องทางเข้าถึงข้อมูลหลัก คือ&nbsp;<strong>เวปไซต์ และ เพจเฟสบุ๊กคณะวิศวกรรมศาสตร์</strong></li><li>นิสิตปัจจุบัน ช่องทางเข้าถึงข้อมูลหลัก คือ&nbsp;<strong>ไลน์กลุ่มหลักสูตรฯ&nbsp;</strong>โดยนิสิตปัจจุบันทุกคน สามารถรับทราบข้อมูลได้ทั่วถึง และรวดเร็ว</li></ul><p style=\"line-height: 21.6px; color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: 12px;\">ดังนั้นในการประชาสัมพันธ์ข่าวสารต่างๆ หลักสูตรฯ จะเน้นการสื่อสาร และอัพเดทข้อมูลผ่านช่องทางดังกล่าวเป็นหลัก</p>', 5.00, 5.00, 'บรรลุ', '3', 'aasdasdasd', 'https://www.google.com/webhp?hl=th&sa=X&ved=0ahUKEwiqybWf0_eKAxWhwjgGHVEaEksQPAgI', '-', '1760860096031-313846454.pdf', 'submitted', 'วิศวกรรมคอมพิวเตอร์', '2025-10-22 06:55:57', '2025-10-22 06:56:40', '[\"1760860096031-313846454.pdf\",\"1760860096121-201951251.pdf\",\"url_0_aasdasdasd\"]', '{\"1760860096031-313846454.pdf\":{\"number\":\"1\",\"name\":\"1\"},\"1760860096121-201951251.pdf\":{\"number\":\"2\",\"name\":\"2\"},\"url_0_aasdasdasd\":{\"number\":\"3\",\"name\":\"aasdasdasd\",\"url\":\"https://www.google.com/webhp?hl=th&sa=X&ved=0ahUKEwiqybWf0_eKAxWhwjgGHVEaEksQPAgI\"}}');
...
(33, 1759486170, 143, NULL, NULL, NULL, 5.00, 'มีการดำเนินงานระดับ 5-7', 'มีการดำเนินงานระดับ 5-7', NULL, 'submitted', '2025-10-03 10:56:57'),
(34, 1759486170, 143, NULL, NULL, NULL, 1.00, 'มีการดำเนินงานระดับ 1	', 'มีการดำเนินงานระดับ 1	', NULL, 'submitted', '2025-10-03 10:57:53'),
(35, 1759486170, 48, NULL, NULL, NULL, 2.00, 'มีการดำเนินงานระดับ 2', 'มีการดำเนินงานระดับ 2', NULL, 'submitted', '2025-10-03 10:58:07'),
(36, 1759486170, 144, NULL, NULL, NULL, 1.00, 'มีการดำเนินงานระดับ 1', 'มีการดำเนินงานระดับ 1', NULL, 'submitted', '2025-10-03 11:17:20'),
(37, 107, 143, NULL, NULL, NULL, 5.00, '	มีการดำเนินงานระดับ 5-7', NULL, NULL, 'submitted', '2025-10-06 12:20:11'),
(38, 107, 144, NULL, NULL, NULL, 5.00, 'มีการดำเนินงานระดับ 3', 'a', NULL, 'submitted', '2025-10-06 14:00:03');
...
--
-- Indexes for table `committee_evaluations_วิศวกรรมคอมพิวเตอร์`
--
ALTER TABLE `committee_evaluations_วิศวกรรมคอมพิวเตอร์`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `committee_evaluations_วิศวกรรมคอมพิวเตอร์`
--
ALTER TABLE `committee_evaluations_วิศวกรรมคอมพิวเตอร์`
...
--
ALTER TABLE `evaluations_actual_ce`
  MODIFY `evaluation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
