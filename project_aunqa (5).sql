...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 03, 2025 at 01:30 PM
...
INSERT INTO `evaluations_actual_ce` (`evaluation_id`, `session_id`, `indicator_id`, `program_id`, `year`, `evaluator_id`, `operation_result`, `operation_score`, `reference_score`, `goal_achievement`, `evidence_number`, `comment`, `evidence_file`, `status`, `major_name`, `created_at`, `updated_at`) VALUES
(3, 2147483647, 143, NULL, NULL, NULL, 'ฟหกฟหกฟหกฟหกฟหกฟหกฟหกฟหกฟหกฟหกฟหกฟหกฟกหกฟหกฟหกฟหกฟหกฟหกฟหก', 5.00, 5.00, 'บรรลุ', 'ABCDEFGHI', 'asdasdasd', NULL, 'submitted', 'วิศวกรรมคอมพิวเตอร์', '2025-10-03 10:26:48', '2025-10-03 10:26:48');
...
--
ALTER TABLE `evaluations_ce`
  MODIFY `evaluation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
